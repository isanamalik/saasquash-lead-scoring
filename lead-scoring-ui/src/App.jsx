...
function App() {
  ...
  const CATEGORY_MAX = {
    CompanySize: 25,
    OwnershipStructure: 25,
    Revenue: 20,
    OperationalMaturity: 15,
    Location: 15,
  };
      ...
      <div className="sidebar">
        ...
        <div className="sidebar-stats">
          ...
          <div className="sidebar-stat-item tier-stat-a">
            ...
            <div>
              <div className="stat-number">
                {leads.filter((l) => l.tier === "A").length}
              </div>
          ...
          <div className="sidebar-stat-item tier-stat-b">
            ...
            <div>
              <div className="stat-number">
                {leads.filter((l) => l.tier === "B").length}
              </div>
          ...
          <div className="sidebar-stat-item tier-stat-c">
            ...
            <div>
              <div className="stat-number">
                {leads.filter((l) => l.tier === "C").length}
              </div>
          ...
          <div className="sidebar-stat-item tier-stat-d">
            ...
            <div>
              <div className="stat-number">
                {leads.filter((l) => l.tier === "D").length}
              </div>
        ...
        <header className="header">
          <div className="header-left">
            ...
            <p className="subtitle">
              Rule-based lead prioritization • {filteredLeads.length} leads
              shown
            </p>
          </div>
        </header>
          ...
          {sortedLeads.map((lead) => (
            ...
            >
              <div className="lead-card-header">
                ...
                <div
                  className={`tier-badge-large tier-${lead.tier.toLowerCase()}`}
                >
                  {lead.tier}
                </div>
              </div>
                ...
                <div className="score-circle">
                  <svg viewBox="0 0 100 100">
                    ...
                    <circle
                      ...
                      style={{
                        strokeDashoffset: 283 - (283 * lead.score) / 100,
                      }}
                    ></circle>
                  </svg>
        ...
        <div className="modal-overlay" onClick={() => setSelectedLead(null)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-header">
              ...
              <div
                className={`tier-badge-large tier-${selectedLead.tier.toLowerCase()}`}
              >
            ...
            <div className="modal-score">
              ...
              <div className="score-breakdown">
                ...
                {Object.entries(selectedLead.scoreBreakdown).map(
                  ([key, value]) => (
                    <div key={key} className="breakdown-item">
                      ...
                      <div className="breakdown-bar">
                        <div
                          ...
                          style={{
                            width: `${(value / CATEGORY_MAX[key]) * 100}%`,
                          }}
                        ></div>
                      </div>
            ...
            <div className="modal-details">
              <div className="modal-detail-grid">
                ...
                <div className="modal-detail-item">
                  ...
                  <div className="modal-detail-value">
                    ${(selectedLead.revenue / 1_000_000).toFixed(1)}M
                  </div>
                </div>
                <div className="modal-detail-item">
